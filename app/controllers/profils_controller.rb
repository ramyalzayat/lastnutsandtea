class ProfilsController < ApplicationController
  ...
  private
    ...
    def profil_params
      params.require(:profil).permit(:first_name, :last_name, :bio, :city_of_origin, :current_location, :asylum_status, :email, :facebook, :twitter, :linkedin, :instagram, :dob, :gender)
    end
end
